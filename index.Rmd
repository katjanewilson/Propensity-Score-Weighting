...
Using a gam model to identify the propensity score, here, and then use the iptw and standardized weights in the estimate. Note that we now have the full sample size, which is an advantage over matching methods.
