...
Such trade offs in matching might be addressed with a more nuanced treatment of the propensity score. Using data from NYC public schools, we can compare the capabilities of various weighting methods, noting the shared technical foundations and general limitations from weighting methods as used in the survey literature. 
